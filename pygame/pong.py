...
font2 = pygame.font.SysFont('나눔고딕', 70)
...
while 1:
    ...
    pygame.draw.line(
        screen, (255, 255, 255),
        (screen.get_width() / 2, 50), (screen.get_width() / 2, screen.get_height()), 3
    )
    pygame.draw.rect(screen, (255, 255, 255), (0, 50, screen.get_width(), screen.get_height() - 50), 3)
    pygame.draw.circle(
        screen, (255, 255, 255),
